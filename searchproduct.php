...
// Conexión a la base de datos
    ...
    // Consulta para obtener productos filtrados por los datos del formulario
    $query = "SELECT product_id, name, brand FROM products WHERE name like '%".$_POST["productinput"]."%' AND brand like '%".$_POST["marcainput"]."%' AND EAN like '%".$_POST["eaninput"]."%' AND type_id like '%".$_POST["inputType"]."%'";
